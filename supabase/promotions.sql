...
-- Run this once in the Supabase SQL Editor before using owner/promotions.html.
...
create table if not exists public.promotions (
  ...
  constraint promotions_valid_dates check (end_date is null or start_date is null or end_date >= start_date),
